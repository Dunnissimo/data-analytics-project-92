...
-- Данный запрос выводит таблицу о продавцах, чья средняя выручка за сделку меньше средней выручки за сделку по всем продавцам
...
-- Данный запрос выводит таблицу о выручке продавцов по дням недели
